...
--
-- Host: localhost    Database: ecoroute
-- ------------------------------------------------------
...
CREATE TABLE `journeys` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `journeys_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `vehicles` (
  ...
  `emission_rate` float NOT NULL COMMENT 'grams CO2 per km',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-10-08 16:31:13
